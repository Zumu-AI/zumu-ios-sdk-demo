...
struct TripSelectionView: View {
    ...
    @StateObject var driver = Driver.shared
    ...
    var body: some View {
        VStack(spacing: 24) {
            // Driver info card
            DriverInfoCard(driver: driver, showingDriverEdit: $showingDriverEdit)
            ...
            if let trip = selectedTrip {
                ...
                Button(action: {
                    Task {
                        await viewModel.startSession(for: trip, driver: driver)
                    }
                }) {
                    HStack {
        ...
        .sheet(isPresented: $showingTripPicker) {
            TripPickerSheet(selectedTrip: $selectedTrip, showingPicker: $showingTripPicker)
        }
...
struct DriverInfoCard: View {
    ...
    @Binding var showingDriverEdit: Bool
